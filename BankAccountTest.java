...
class BankAccountTest {
	...
	void setUp() throws Exception {
		...
		this.customer = new Customer("Simon");
	...
	void testDeposit() {
		...
		// make a negative amount deposit
		this.myCheckingAccount.deposit(-100);
		
		// deposit should be the same
		assertEquals(100, this.myCheckingAccount.balance);
	...
	void testWithdraw() {
		...
		// try to withdraw amount greater than current balance
		// expect an exception
